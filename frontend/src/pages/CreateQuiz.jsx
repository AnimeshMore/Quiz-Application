...
const CreateQuiz = () => {
    ...
    const addQuestion = async (e) => {
        ...
        if (correctOption == undefined) {
            alert("You have to select an correct option")
            ...
            axios.post("/api/v1/question/", newQuestion).then((response) => {
                console.log(response);
                const data = response.data.question._id;
                console.log(data);
    ...
    const handleOptions = ({ data, inputOption }) => {
        ...
        for (let i = 0; i < inputOption.length; i++) {
            ...
            console.log(option);
            axios.put("/api/v1/question/" + data, option).then((response) => {
    ...
    const getExams = async () => {
        ...
        console.log(data);
        setExamDatas(data.question);
        console.log(data.options)
    }

    const deleteQuestion = (propId) => {
        axios.delete('/api/v1/question/' + propId).then((response) => {
            console.log(response.status);
